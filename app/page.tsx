    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <div className="min-h-screen h-full w-full dark:bg-black bg-white  dark:bg-grid-white/[0.2] bg-grid-black/[0.2] relative flex items-center justify-center">
        ...
        <p className="text-4xl sm:text-7xl font-bold relative z-20 bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-500 py-8">
          <div className="h-auto py-24 px-6 w-full rounded-xl flex md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
            <Spotlight
            ...
            <div className="mx-auto relative z-10  w-full md:pt-0">
              ...
              <p className="mt-4 font-normal text-base text-neutral-300 max-w-lg text-center mx-auto">
                ...
                Elevate your comfort. Elevate your game - only at <span className="text-blue-500 font-bold dark:text-blue-500"> Sneak Shop
                India</span>.
              </p>
              <div className="w-full flex items-center justify-center pt-8">
             
<Drawer >
  <DrawerTrigger> <button className="px-8 py-0.5  border-2 border-black dark:border-white uppercase bg-blue-500 text-white transition duration-200 text-xs shadow-[1px_1px_rgba(0,0,0),2px_2px_rgba(0,0,0),3px_3px_rgba(0,0,0),4px_4px_rgba(0,0,0),5px_5px_0px_0px_rgba(0,0,0)] dark:shadow-[1px_1px_rgba(255,255,255),2px_2px_rgba(255,255,255),3px_3px_rgba(255,255,255),4px_4px_rgba(255,255,255),5px_5px_0px_0px_rgba(255,255,255)] ">
  Read more
